    ...
    while (!q.empty()) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            if (inbounds(ny,nx) && (arr[ny][nx] == 1 || arr[ny][nx] == 4)) {
                if (points[py][px].pads < points[ny][nx].pads || (points[py][px].pads == points[ny][nx].pads && points[py][px].jumps + 1 < points[ny][nx].jumps)) {
                ...
                else if (points[py][px].pads == points[ny][nx].pads && points[py][px].jumps +1 == points[ny][nx].jumps) {
                    points[ny][nx].ways+=points[py][px].ways;
                    if (!points[ny][nx].visited) {
                        points[ny][nx].visited = 1;
                        point n;
                ...
                if (points[py][px].pads +1 < points[ny][nx].pads || (points[py][px].pads + 1 == points[ny][nx].pads && points[py][px].jumps + 1 < points[ny][nx].jumps)) {
                ...
                //if (py == 4 && px == 8 && points[py][px].pads == 2) cout << ny << " " << nx << " " << points[ny][nx].pads << endl;
                else if (points[py][px].pads + 1 == points[ny][nx].pads && points[py][px].jumps +1 == points[ny][nx].jumps) {
                    points[ny][nx].ways+=points[py][px].ways;
                    if (!points[ny][nx].visited) {
                        points[ny][nx].visited = 1;
                        point n;
