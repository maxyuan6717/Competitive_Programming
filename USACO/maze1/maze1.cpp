...
int main() {
    ...
    for (counter = 0; counter < 2; counter++) {
    	...
    	//dist[counter][start[0]][start[1]] = 1;
    	
    	//
    	
    }
    counter = 0;
    //cout << exit1[0][0] << " " << exit1[0][1] << endl;
    //cout << exit1[1][0] << " " << exit1[1][1] << endl;
    //cout << start[0][1] << " " << start[0][0] << endl;
    cout << start[0][0] << " " << start[0][1] << endl;
    cout << start[1][0] << " " << start[1][1] << endl;
